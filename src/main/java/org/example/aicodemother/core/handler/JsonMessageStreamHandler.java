...
import org.example.aicodemother.ai.model.message.StreamMessage;
...
import org.example.aicodemother.model.enums.StreamMessageTypeEnum;
...
public class JsonMessageStreamHandler {
    ...
    public Flux<String> handle(Flux<String> originFlux,
        ...
        return originFlux
                ...
                .doOnError(error -> {
                    ...
                    chatHistoryService.addAiErrorMessage(appId, loginUser.getId(), parentId, errorMessage);
                });
    }
    ...
    private String handleJsonMessageChunk(String chunk, StringBuilder chatHistoryStringBuilder, Set<String> seenToolIds) {
        ...
        ThrowUtils.throwIf(typeEnum == null, ErrorCode.PARAMS_ERROR, "消息类型错误");
        switch (typeEnum) {
            case AI_RESPONSE -> {
